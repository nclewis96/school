...
* ====      ======          ===========
* 10/18/16	Nathaniel Lewis	Initial implementation and test
*
* DESCRIPTION:
...
/* L01 */int numTowns = 0;
/* L01 */int numPairs = 0;
/* L01 *//*std::string fileName;
	     std::cout << "\n Please enter a file name: ";
	     std::cin >> fileName;
	     std::ifstream townFile(fileName);
        //Read in file containing towns and their connections
        townFile >> numTowns;
	    townFile >> numPairs;
       */
/* L02 */std::cin >> numTowns;
/* L03 */std::cin >> numPairs;
        int townA = 0;
	    int townB = 0;
