...
{
  "$end", "error", "$undefined", "INT", "TEMP", "HUMID", "ON", "OFF",
  "HEAT", "'\\n'", "$accept", "program", "cmd", 0
};
#endif
...
/* Line 1806 of yacc.c  */
#line 29 "therm.y"
    { 	if(pwr == 1 && (yyvsp[(2) - (2)]) > 45 && (yyvsp[(2) - (2)]) < 85 ) {
									temp = (yyvsp[(2) - (2)]);
...
#line 39 "therm.y"
    {  
								if(pwr == 1 && (yyvsp[(2) - (2)]) > 35 && (yyvsp[(2) - (2)]) < 75 ) {
									hum = (yyvsp[(2) - (2)]);
