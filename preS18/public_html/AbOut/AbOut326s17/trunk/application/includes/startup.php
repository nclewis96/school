<?php
	...
	try
	{
		$DB_Read = new PDO('mysql:dbname=AbOut326s17db;host=localhost', 'web_user', 'resu_bew');
		$DB_Write = new PDO('mysql:dbname=AbOut326s17db;host=localhost', 'web_user', 'resu_bew');
	}
